...
def fit_peak(bincenters,y,params,input):
    ...
    x = bincenters 
    # sets region to fit. Determined by taking the peak location 'params[1]' and adding and subtracting the width of the peak 'params[2]' and removing data outside that interval. 
