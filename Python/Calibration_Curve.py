...
def Calibration_Curve(ADC,ADC_loc,EN,Error,N,title,detector):
    ...
    slope, intercept, r_value, p_value, std_err = stats.linregress(ADC,EN) #preforms linear regression(fit) for ADC location and expected peak energies. 
    ...
    plt.errorbar(adc,EN,yerr=Error,fmt ='o')
